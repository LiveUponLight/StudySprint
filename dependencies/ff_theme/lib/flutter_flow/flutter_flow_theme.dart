...
abstract class FlutterFlowTheme {
  ...
  String get normalTextFamily => typography.normalTextFamily;
  TextStyle get normalText => typography.normalText;
  String get headerTextFamily => typography.headerTextFamily;
  TextStyle get headerText => typography.headerText;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF261A90);
  late Color secondary = const Color(0xFFFFFFFF);
  late Color tertiary = const Color(0xFFF2C94C);
...
abstract class Typography {
  ...
  String get normalTextFamily;
  TextStyle get normalText;
  String get headerTextFamily;
...
class ThemeTypography extends Typography {
  ...
  String get normalTextFamily => 'Inter';
  TextStyle get normalText => GoogleFonts.inter(
        color: Colors.black,
        fontSize: 19.0,
      );
  String get headerTextFamily => 'Inter';
  TextStyle get headerText => GoogleFonts.inter(
        color: Colors.black,
        fontSize: 40.0,
      );
}
